...
CREATE TABLE roles (id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, departments_id INT NOT NULL, title VARCHAR(50) NOT NULL, salary DECIMAL(8, 2) NOT NULL, CONSTRAINT fk_departments FOREIGN KEY (departments_id), REFERENCES departments (id) ON DELETE CASCADE);
